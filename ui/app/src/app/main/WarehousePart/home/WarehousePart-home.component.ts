...
@Component({
  selector: 'WarehousePart-home',
  templateUrl: './WarehousePart-home.component.html',
  styleUrls: ['./WarehousePart-home.component.scss']
})
export class WarehousePartHomeComponent implements AfterViewInit {
