...
@Component({
  selector: 'CarPart-home',
  templateUrl: './CarPart-home.component.html',
  styleUrls: ['./CarPart-home.component.scss']
})
export class CarPartHomeComponent implements AfterViewInit {
