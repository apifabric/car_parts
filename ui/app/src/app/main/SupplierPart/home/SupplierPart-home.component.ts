...
@Component({
  selector: 'SupplierPart-home',
  templateUrl: './SupplierPart-home.component.html',
  styleUrls: ['./SupplierPart-home.component.scss']
})
export class SupplierPartHomeComponent implements AfterViewInit {
